...
keywords = frozenset(['__asm', '__builtin', '__cdecl', '__declspec', '__except', '__export', '__far16', '__far32',
                      ...
                      'PQresultStatus','ifdef','endif','bool','void','start_if_statement', 'start_compound_statement',
                      'start_for_statement', 'start_while_statement', 'start_do_statement','start_catch_clause',
                      'start_case_statement', 'start_try_statement', 'start_assignment_expression','start_member_expression',
                      'start_switch_statement', 'start_function_definition', 'start_expression_statement', 'start_continue_statement',
                      'start_break_statement','start_return_statement', 'start_call_expression', 'start_access_specifier',
                      'start_pointer_declarator','end_if_statement', 'end_compound_statement', 'end_for_statement',
                      'end_while_statement', 'end_do_statement','end_catch_clause', 'end_case_statement', 'end_try_statement',
                      'end_assignment_expression','end_member_expression','end_switch_statement', 'end_function_definition',
                      'end_expression_statement', 'end_continue_statement','end_break_statement','end_return_statement',
                      'end_call_expression', 'end_access_specifier', 'end_pointer_declarator'])

a=['start_if_statement', 'start_compound_statement', 'start_for_statement', 'start_while_statement', 'start_do_statement',
                            'start_catch_clause', 'start_case_statement', 'start_try_statement', 'start_assignment_expression',
                            'start_member_expression',
                            'start_switch_statement', 'start_function_definition', 'start_expression_statement', 'start_continue_statement',
                            'start_break_statement',
                            'start_return_statement', 'start_call_expression', 'start_access_specifier', 'start_pointer_declarator']
b=['end_if_statement', 'end_compound_statement', 'end_for_statement', 'end_while_statement', 'end_do_statement',
                            'end_catch_clause', 'end_case_statement', 'end_try_statement', 'end_assignment_expression',
                            'end_member_expression',
                            'end_switch_statement', 'end_function_definition', 'end_expression_statement', 'end_continue_statement',
                            'end_break_statement',
                            'end_return_statement', 'end_call_expression', 'end_access_specifier', 'end_pointer_declarator']
...
def clean_gadget(gadget):
    ...
    for line in gadget:
        ...
        if rx_comment.search(line) is None:
            ...
            # ascii_line=re.sub(r'^CWE\d+_+', 'type', ascii_line)
            ...
            ascii_line = re.sub(r'CWE\d+.*?(?=\s|$)', 'type', ascii_line)
